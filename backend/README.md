...
## Project Structure
    ...
    ├── ilovemyself_fitness_30427  # Django project configurations
...
1. Clone this repo and `cd ilovemyself_fitness_30427`
...
2. Clone this repo and `cd ilovemyself_fitness_30427`
